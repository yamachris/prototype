...
export class GameController {
  ...
  async setupGame(@Param("gameId") gameId: string, @Body() body: { card: Card }) {
  ...
  async placeCard(@Param("gameId") gameId: string, @Body() body: { suit: Suit; selectedCards: Card[] }) {
    return await this.gameService.handleCardPlace(gameId, body.suit, body.selectedCards);
  }
