...
export function DeckArea() {
  const { deck, currentPlayer, handleDrawCard, recycleDiscardPile, phase } = useGameStore();
        ...
        <button
          ...
          {isDeckEmpty && hasDiscardPile ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-blue-50 dark:bg-blue-900/50 rounded-xl">
              ...
              <span className="text-sm font-medium text-blue-600 dark:text-blue-400 mt-2">Recyclage automatique</span>
            </div>
          ) : (
