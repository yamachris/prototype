  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl">
        <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Défi de la Bonne Dame</h2>

        <p className="text-gray-600 dark:text-gray-400 mb-6">Devinez la couleur de la Dame qui sera jouée</p>
            ...
            <button
              ...
              <div className="flex flex-col items-center gap-2">
                <Icon
                  className={cn(
                    "w-8 h-8",
                    suit === "HEARTS" || suit === "DIAMONDS" ? "text-red-500" : "text-gray-800 dark:text-gray-200"
                  )}
                />
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            ...
            className={cn(
              ...
              selectedSuit ? "bg-blue-600 text-white hover:bg-blue-700" : "bg-gray-200 text-gray-500 cursor-not-allowed"
            )}>
            Confirmer
          </button>
        </div>
