...
describe("Mécanique d'activation des colonnes", () => {
  ...
  describe("handleCardPlacement", () => {
    ...
    test("Activation réussie avec As + 7", () => {
      const { updatedColumn } = handleCardPlacement([asCoeur, septCoeur], emptyColumn, player);
    ...
    test("Activation réussie avec As + Joker", () => {
      const { updatedColumn } = handleCardPlacement([asCarreau, jokerRouge], emptyColumn, player);
    ...
    test("Les cartes sont retirées de la main du joueur", () => {
      const { updatedPlayer } = handleCardPlacement([asCoeur, septCoeur], emptyColumn, player);
